...
<html>
<head>
	<title>LAPORAN Laundry Najib Barokah</title>
</head>
<body>
	<form method="post">
		<table align="center">
			<tr>
				<td>
					<div class="mainutama">
						<table align="center">
							<tr>
       						...
       						<td width="93%" valign="bottom">&nbsp;LAPORAN LAUNDRY NAJIB BAROKAH</td>
							</tr>
							<tr>
								<td colspan="2">Jl.Jatisari,Karangmiri,Sumampir,Kec.Purwokerto Utara,Kabupaten Banyumas,Jawa Tengah 53125</td>
							</tr>
						</table>
						<table width="100%">
						<tr><td><hr></td></tr>
			    	...
			    	<table align="center">
			      		<tr>
			        	<td>&copy; <?php echo date('Y'); ?> LNB</td>
			      		</tr>
			    	</table>
					</div>
				</td>
