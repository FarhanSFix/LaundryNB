...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/stock-vector-seamless-pattern-with-laundry-icons-vector-blue-and-white-illustration-with-accessories-for-362123054.jpg"))); // NOI18N

        jPanel2.setBackground(new java.awt.Color(204, 204, 204));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/icons8-washing-machine-100.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("MV Boli", 1, 48)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 51));
        jLabel2.setText("Laundry Najib Barokah");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel3.setText("Jl. Jatisari, Karangmiri, Sumampir, Kec. Purwokerto Utara, Kabupaten Banyumas, Jawa Tengah 53125");
        ...
        pelanggan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/icons8-businessman-50.png"))); // NOI18N
        ...
        jenis_cucian.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/icons8-washing-machine-50.png"))); // NOI18N
        ...
        penerimaan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/icons8-reserve-50.png"))); // NOI18N
        ...
        transaksi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/icons8-purchase-order-50.png"))); // NOI18N
        ...
        laporan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/icons8-system-report-50.png"))); // NOI18N
        ...
        tentang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/icons8-about-50.png"))); // NOI18N
        ...
        exit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Laundry/Icon/icons8-shutdown-filled-50(1).png"))); // NOI18N
        exit.setText("Keluar");
    ...
    private void laporanMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_laporanMousePressed
        if(Desktop.isDesktopSupported()){
            try{
                Desktop.getDesktop().browse(new URL("http://localhost/LaundryNajibBarokah/laporan.php").toURI());
            } catch(Exception e){
                e.printStackTrace();
            }
        }
